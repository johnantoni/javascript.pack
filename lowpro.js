...
Remote = Behavior.create({
  initialize: function(options) {
    if (this.element.nodeName == 'FORM') { var rf = new Remote.Form(this.element, options); }
    else { var rl = new Remote.Link(this.element, options); }
  }
});
...
Remote.Base = {
  ...
  _makeRequest : function(options) {
    if (options.update) { var aju = new Ajax.Updater(options.update, options.url, options); }
    else { var ajr = new Ajax.Request(options.url, options); }
    return false;
  },
